...
function condicao(a, b) {
    return igual(a,b) && negacao(b); // AND OR NOT
    
    // tabela verdade &&
    // só é verdadeiro quando os 2 lados da condição forem verdadeiros

    // pesquisar tabela verdade
}
